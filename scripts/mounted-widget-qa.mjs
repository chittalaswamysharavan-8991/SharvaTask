...
for (const viewport of [{name:'desktop',width:1280,height:900},{name:'mobile',width:390,height:844}]) {
 ...
 await page.getByText('Open/Edit',{exact:true}).click();
 ...
 await page.getByText('Refresh',{exact:false}).first().click(); await page.waitForTimeout(200);
 await page.getByText('History',{exact:false}).first().click(); await page.waitForTimeout(200);
